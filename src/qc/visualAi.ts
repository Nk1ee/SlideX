...
export type ImageAiQualityReport = z.infer<typeof imageAiQualityReportSchema>;
export type SlideAiQualityReport = z.infer<typeof slideAiQualityReportSchema>;

export type ImageAiQualityInput = {
  slide: Slide;
  image: ImageCandidate & { bytes: Uint8Array };
};

export type SlideAiQualityInput = {
  slide: Slide;
  png: Uint8Array;
};
