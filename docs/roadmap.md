...
2. Собрать канонические презентации на 10 и 13 слайдов из полного набора layouts, проверить визуальный ритм, повторения, источники и точное количество слайдов. Не вводить silent fallback.
