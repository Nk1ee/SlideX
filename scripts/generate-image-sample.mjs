...
const presentation = {
  ...
  slides: [{ number: 1, type: 'content', layout: 'image_text', title: 'Схема нейронной сети', subtitle: '', bullets: ['Иллюстрация показывает связи между слоями нейронной сети'], cards: [], columns: [], comparison: null, statistics: null, timeline: [], steps: [], definition: null, quote: null,
