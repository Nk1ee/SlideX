...
const presentation = {
  ...
  slides: [{ number: 1, type: 'title', layout: 'title', title: 'Пример титульного слайда', subtitle: '', bullets: [], cards: [], columns: [], comparison: null, statistics: null, timeline: [], steps: [], definition: null, quote: null, visual: { needed: false, type: 'none', concept: '', query_en: '', placement: 'supporting' }, sources: [] }],
};
